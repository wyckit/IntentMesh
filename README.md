...
[![tests](https://img.shields.io/badge/tests-177%2F177-34d399.svg)](#status)
...
# tests
dotnet test IntentMesh.slnx                                   # 177/177
```
...
operator workflow, audit operations). **177/177 tests · IntentBench 25/25 · TLM 7/7.**
...
7/7 round-trip verify; typed action contracts across four domains. **xUnit 177/177.** Five demo
